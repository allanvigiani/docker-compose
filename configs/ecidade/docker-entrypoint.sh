...
sed -i '704s/.*/register_globals = On/' /usr/local/etc/php/php.ini
sed -i '714s/.*/register_long_arrays = On/' /usr/local/etc/php/php.ini
sed -i '729s/.*/register_argc_argv = On/' /usr/local/etc/php/php.ini
sed -i '741s/.*/post_max_size = 64M/' /usr/local/etc/php/php.ini
sed -i '757s/.*/magic_quotes_gpc = On/' /usr/local/etc/php/php.ini
sed -i '892s/.*/upload_max_filesize = 64M/' /usr/local/etc/php/php.ini
sed -i '920s/.*/default_socket_timeout = 60000/' /usr/local/etc/php/php.ini
sed -i '444s/.*/max_execution_time = 60000/' /usr/local/etc/php/php.ini
sed -i '454s/.*/max_input_time = 60000/' /usr/local/etc/php/php.ini
sed -i '465s/.*/memory_limit = 512M/' /usr/local/etc/php/php.ini
sed -i '334s/.*/allow_call_time_pass_reference = On/' /usr/local/etc/php/php.ini
sed -i '538s/.*/display_errors = Off/' /usr/local/etc/php/php.ini
sed -i '559s/.*/log_errors = On/' /usr/local/etc/php/php.ini
sed -i '646s/.*/error_log = \/var\/www\/log\/php-scripts.log/' /usr/local/etc/php/php.ini
sed -i '1516s/.*/session.gc_maxlifetime = 7200/' /usr/local/etc/php/php.ini
